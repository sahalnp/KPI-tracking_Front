...
import { Calendar, Users, TrendingUp, DollarSign, Package, Award } from 'lucide-react'
...
export  function SalesReports() {
  ...
  const [allSalesData, setAllSalesData] = useState<any>({
    ...
    totalQtySold: 3500,
    staffRanking: [
      { staffId: 1, staff: { name: 'John Doe' }, totalQtySold: 450, totalProfit: 125000, totalPoints: 850 },
      { staffId: 2, staff: { name: 'Jane Smith' }, totalQtySold: 380, totalProfit: 95000, totalPoints: 720 },
      { staffId: 3, staff: { name: 'Mike Johnson' }, totalQtySold: 320, totalProfit: 78000, totalPoints: 650 }
    ]
  })
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* Summary Statistics - Compact 2x2 Grid */}
      {allSalesData && allSalesData.staffRanking?.length > 0 && (
        <div className="grid grid-cols-2 gap-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
              ...
              <CardContent className="p-3">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1">
                    <p className="text-lg font-semibold">{allSalesData.totalSales || 0}</p>
            ...
            <Card>
              <CardContent className="p-3">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1">
                    <p className="text-lg font-semibold">{formatCurrency(allSalesData.totalProfit || 0)}</p>
            ...
            <Card>
              <CardContent className="p-3">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1">
                    <p className="text-lg font-semibold">{formatNumber(allSalesData.totalQtySold || 0)}</p>
                    <p className="text-xs text-gray-600">Qty Sold</p>
                  </div>
                </div>
              </CardContent>
            </Card>
