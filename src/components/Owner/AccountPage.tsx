...
export default function AccountSettings() {
    ...
    const tabOrder = ["user", "kpi", "account"];

    const getDirection = (newTab: string) => {
        const oldIndex = tabOrder.indexOf(previousTab);
        ...
        <div className="h-screen overflow-y-auto">
            ...
            >
                <TabsList className="grid w-full grid-cols-3 bg-gray-100 p-1 rounded-lg">
                 ...
                 data-[state=active]:bg-[#FF3F33] data-[state=active]:text-white
                 data-[state=active]:shadow-md hover:bg-[#FF3F33]/10 hover:text-[#FF3F33]"
                    >
