...
import { Home, ClipboardCheck, UserX, User, Users,LayoutDashboard, Target } from "lucide-react";
...
function BottomNav({ userRole, currentPage, onNavigate }: BottomNavProps) {
  const supervisorTabs = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, to: "/owner/dashboard" },
